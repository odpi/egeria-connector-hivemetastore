...
public class ExceptionHelper {
     ...
     */
    public static void raiseConnectorCheckedException(String className, HMSOMRSErrorCode errorCode, String methodName, Exception cause, String... params) throws ConnectorCheckedException {
        if (cause == null) {
     ...
     */
    public static void raiseRepositoryErrorException(String className, HMSOMRSErrorCode errorCode, String methodName, Throwable cause, String... params) throws RepositoryErrorException {
        if (cause == null) {
