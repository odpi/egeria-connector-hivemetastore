...
public enum HMSOMRSErrorCode implements ExceptionMessageSet {
    ...
    COLLECTION_FAILED_INITIALISE(400, "OMRS-HMS-REPOSITORY-400-068 ",
    ...
    FOLDER_DOES_NOT_EXIST(400, "OMRS-HMS-REPOSITORY-400-069 ",
    ...
    NOT_A_FOLDER(400, "OMRS-HMS-REPOSITORY-400-070 ",
                 "The endpoint {0} in the configuration exists on the file system, but is not a folder. ",
                 "Connector is unable to be used",
                 "Review the Endpoint in the configuration to ensure it exists and points to a folder that exists."),
    UNABLE_TO_INITIALISE_CACHE(400, "OMRS-HMS-REPOSITORY-400-071 ",
                          "The cache failed to initialise",
                          "Connector is unable to be used",
                          "Review your configuration to ensure it is valid. Check the logs and debug."),
    IOEXCEPTION_ACCESSING_FILE(400, "OMRS-HMS-REPOSITORY-400-072 ",
    ...
    //    CLASSIFICATION_ERROR_EXCEPTION(400, "OMRS-HMS-REPOSITORY-400-077 ",
//                             "Classification error exception",
//                             "Connector is unable to be used",
//                             "Review the configuration. Check the logs and debug."),
//    STATUS_NOT_SUPPORTED_ERROR_EXCEPTION(400, "OMRS-HMS-REPOSITORY-400-078 ",
...
//                                   "Review the configuration. Check the logs and debug."),
    ...
    INVALID_FOLDER_FAILURE(400, "OMRS-HMS-REPOSITORY-400-085 ",
    ...
    INVALID_SEARCH(400, "OMRS-HMS-REPOSITORY-400-086 ",
    ...
    REGEX_NOT_IMPLEMENTED(501, "OMRS-HMS-REPOSITORY-501-001 ",
    ...
    INVALID_ENTITY_ERROR_EXCEPTIONNO_HISTORY(501, "OMRS-HMS-REPOSITORY-501-002 ",
