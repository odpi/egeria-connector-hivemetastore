...
public class CachingOMRSMetadataCollection extends OMRSDynamicTypeMetadataCollectionBase {
    ...
    public CachingOMRSMetadataCollection(CachingOMRSRepositoryProxyConnector parentConnector,
       ...
       if (configuredEmbeddedConnectors == null || configuredEmbeddedConnectors.isEmpty()) {
           raiseRepositoryErrorException(HMSOMRSErrorCode.EMBEDDED_CONNECTOR_NOT_SUPPLIED, methodName, null, repositoryName);
       } else if (configuredEmbeddedConnectors.size() > 1) {
           raiseRepositoryErrorException(HMSOMRSErrorCode.MULTIPLE_EMBEDDED_CONNECTORS_SUPPLIED, methodName, null, repositoryName);
       } else {
           ...
           if (connector instanceof  OMRSRepositoryConnector) {
               ...
               raiseRepositoryErrorException(HMSOMRSErrorCode.EMBEDDED_CONNECTOR_WRONG_TYPE, methodName, null, repositoryName);
           }
       }
     ...
     */
    private void raiseRepositoryErrorException(HMSOMRSErrorCode errorCode, String methodName, Exception cause, String ...params) throws RepositoryErrorException {
        if (cause == null) {
