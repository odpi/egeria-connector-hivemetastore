...
public class CachingOMRSRepositoryProxyConnector extends OMRSRepositoryConnector
    ...
    public synchronized void start() throws ConnectorCheckedException {
        ...
        auditLog.logMessage(methodName, HMSOMRSAuditCode.REPOSITORY_SERVICE_STARTING.getMessageDefinition());
        synchronized (this) {
        ...
        auditLog.logMessage(methodName, HMSOMRSAuditCode.REPOSITORY_SERVICE_STARTED.getMessageDefinition(getServerName()));
    ...
    public synchronized void disconnect() {
        ...
        auditLog.logMessage(methodName, HMSOMRSAuditCode.REPOSITORY_SERVICE_SHUTDOWN.getMessageDefinition(getServerName()));
    }
